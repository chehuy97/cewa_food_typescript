...
import { get_all_notes, add_new_note, edit_note, remove_note, add_new_user_in_note } from '../controllers/note.controller'
...
noteRouter.post('/user/', add_new_user_in_note)